...
function HeroSection() {
  return (
    <section className="relative flex min-h-[60vh] items-center overflow-hidden bg-slate-950 px-4 py-20 text-white sm:px-6 lg:px-8">
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(15,23,42,0.82)_0%,rgba(15,23,42,0.66)_50%,rgba(15,23,42,0.9)_100%)]" />
              ...
              >
                <div className="flex h-full flex-col overflow-hidden rounded-[1.7rem] bg-white">
                  <div className="relative aspect-[16/11] overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(15,23,42,0.1)_0%,rgba(15,23,42,0.12)_100%)]" />
                    <div className="absolute left-5 top-5 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-blue-700 shadow-lg shadow-blue-700/10">
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <div className="mt-6">
                      <Link
                        href="/contact"
                        className="inline-flex items-center justify-center rounded-full bg-blue-700 px-5 py-2.5 text-sm font-semibold text-white transition duration-300 hover:-translate-y-0.5 hover:bg-blue-800"
                      >
                        Learn More
                      </Link>
                    </div>
